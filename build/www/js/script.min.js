...
function loadBonzis(a) {
    loadQueue.loadManifest([
       { id: "bonziAqua", src: "./img/bonzi/aqua.png" },
        ...
        { id: "bonziNavy", src: "./img/bonzi/navy.png" },
        ...
        { id: "bonziFemboykisser", src: "./img/bonzi/femboykisser.png" },
        { id: "bonziLavenderribbon", src: "./img/bonzi/lavenderribbon.png" },
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow","quartz", "nethergold","purplesaber","pope","blessed","cameraman","cartoonnetwork","brasilempire","stella","grinnyboi","yan","peedy" ,"bustystickwoman", "femboykisser", "ruby","navy", "chartreuse", "sapphire","lavenderribbon" ], b = 0; b < a.length; b++) {
                    var c = a[b],
                 ...
                 (this.loadHats = function () {
                    var a = { witch: "https://files.catbox.moe/9xw19z.webp", chain: "https://files.catbox.moe/me46mf.webp", cigar: "https://files.catbox.moe/k9ez0y.webp", obama: "https://files.catbox.moe/387att.webp",police: "https://i.ibb.co/b51bFd3c/police.webp"  };
                    for (var b in a) {
                        var c = new Image();
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziAqua", "bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziDiamond", "bonziEmerald", "bonziGold", "bonziGreen", "bonziLime", "bonziOrange", "bonziPink", "bonziPurple", "bonziRed", "bonziPink", "bonziWhite", "bonziYellow",  "bonziPurplesaber" ,"bonziNethergold","bonziQuartz"  ,"bonziCartoonnetwork", "bonziBrasilempire","bonziStella","bonziGrinnyboi","bonziYan",  "bonziPeedy",  "bonziBustystickwoman", "bonziRuby", "bonziNavy", "bonziSapphire", "bonziChartreuse", "bonziLavenderribbon", "bonziFemboykisser",  "topjej"];
